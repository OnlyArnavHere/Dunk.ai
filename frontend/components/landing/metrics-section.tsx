...
export function MetricsSection() {
  ...
  return (
    <section id="metrics" ref={sectionRef} className="relative py-32 lg:py-48 bg-[#06080e] overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row gap-24 lg:gap-12">
          ...
          <div className="flex-1">
            <h2
              className={`text-5xl lg:text-7xl font-light tracking-[-0.02em] text-white transition-all duration-1000 ease-out ${
                isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
              }`}
            >
              The new standard
              <br />
              <span className="font-serif italic text-white/50">in hardware.</span>
            </h2>
            <div className={`mt-16 w-16 h-[1px] bg-white/20 transition-all duration-1000 delay-300 ${
          ...
          <div className="flex-1 flex flex-col gap-16 lg:gap-24 lg:pl-24">
            {metrics.map((metric, index) => (
              ...
              >
                ...
                <div className="text-sm lg:text-base font-mono tracking-widest uppercase text-white/40 max-w-[150px]">
                  {metric.label}
                </div>
              </div>
            ))}
